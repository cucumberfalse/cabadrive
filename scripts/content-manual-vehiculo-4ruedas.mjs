...
export const EXPECTED_SOURCE = {
  ...
  sourceUrl:
    "https://static.buenosaires.gob.ar/sites/default/files/2024-11/MANUAL_Vehiculo_4Ruedas_2023%20SA.pdf",
};
...
const MANUAL_TOP_LEVEL_NAVIGATION = [
  {
    ...
    children: [
      {
        id: "front-title",
        titleRu: "Титульная страница",
        titleEs: "Portada",
        startPage: 1,
        endPage: 1,
        sourceEvidence: "page_heading",
      },
      {
        id: "front-presentation",
        titleRu: "Презентация",
      ...
      },
      {
        ...
        titleEs: "Material por categorías",
        startPage: 3,
        endPage: 4,
        sourceEvidence: "page_heading",
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        titleEs: "Accidente o incidente vial?",
        startPage: 17,
        sourceEvidence: "index_pages_11_12",
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        id: "ch1-cities-for-people",
        titleRu: "Города для людей",
        titleEs: "Ciudades para las personas",
        startPage: 22,
        sourceEvidence: "index_pages_11_12",
      },
      {
      ...
      {
        id: "ch1-pedestrian-priority",
        titleRu: "Пешеходный приоритет",
        titleEs: "Prioridad peatonal",
        startPage: 24,
        sourceEvidence: "index_pages_11_12",
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        id: "ch2-legal-responsibility",
        titleRu: "Юридическая ответственность",
        titleEs: "Responsabilidad juridica",
        startPage: 44,
        sourceEvidence: "index_pages_11_12",
      },
      {
        ...
        titleEs: "Documentacion obligatoria",
        startPage: 46,
        sourceEvidence: "index_pages_11_12",
      },
      {
      ...
      },
      {
        ...
        titleEs: "Sistema de puntos Scoring",
        startPage: 56,
        sourceEvidence: "index_pages_11_12",
      },
    ],
  },
  {
    ...
    children: [
      {
        id: "ch3-priority-of-rules",
        titleRu: "Приоритет норм",
        titleEs: "Prioridad normativa",
        startPage: 58,
        sourceEvidence: "index_pages_11_12",
      },
      {
      ...
      },
      {
        ...
        titleEs: "Giros en intersecciones",
        startPage: 75,
        sourceEvidence: "index_pages_11_12",
      },
      {
        ...
        titleEs: "Adelantamiento y sobrepaso",
        startPage: 76,
        sourceEvidence: "index_pages_11_12",
      },
      {
      ...
      {
        id: "ch3-stopping-parking",
        titleRu: "Остановка и стоянка",
        titleEs: "Detencion y estacionamiento",
        startPage: 83,
        sourceEvidence: "index_pages_11_12",
      },
    ],
  },
  {
    ...
    children: [
      {
        id: "ch4-alcohol-drugs",
        titleRu: "Употребление алкоголя и наркотиков",
        titleEs: "Consumo de alcohol y drogas",
        startPage: 90,
        sourceEvidence: "index_pages_11_12",
      },
      {
        id: "ch4-sleep-fatigue",
        titleRu: "Сон и усталость",
        titleEs: "Sueno y fatiga",
        startPage: 93,
        endPage: 94,
        sourceEvidence: "index_pages_11_12",
      },
  ...
  },
  {
    ...
    children: [
      {
        id: "ch5-attitude-types",
        titleRu: "Типы установок",
        titleEs: "Tipos de actitudes",
        startPage: 99,
        sourceEvidence: "index_pages_11_12",
      },
      {
        id: "ch5-equal-society",
        titleRu: "К равноправному обществу",
        titleEs: "Hacia una sociedad igualitaria",
        startPage: 100,
        sourceEvidence: "index_pages_11_12",
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        id: "app1-safety-elements",
        titleRu: "Элементы безопасности",
        titleEs: "Elementos de seguridad",
        startPage: 105,
        sourceEvidence: "index_pages_11_12",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: "app2-safe-driving",
        titleRu: "Безопасное вождение",
        titleEs: "Conduccion segura",
        startPage: 144,
        sourceEvidence: "index_pages_11_12",
      },
      {
        id: "app2-highways-hospitals",
        titleRu: "Автомагистрали и больницы",
        titleEs: "Autopistas y hospitales",
        startPage: 149,
        sourceEvidence: "index_pages_11_12",
      },
    ],
  },
  {
    ...
    children: [
      {
        id: "app3-cargo-driver-profile",
        titleRu: "Профиль перевозчика грузов",
        titleEs: "Perfil del transportista de carga",
        startPage: 153,
        sourceEvidence: "index_pages_11_12",
      },
      {
        id: "app3-social-responsibility",
        titleRu: "Социальная ответственность",
        titleEs: "Responsabilidad social",
        startPage: 155,
        sourceEvidence: "index_pages_11_12",
...
const MANUAL_TOPIC_START_TEXT_EVIDENCE = new Map([
  ...
  [
    "ch4-distractions",
    { startPage: 95, requiredText: ["Отвлечения", "Под отвлечением понимается"] },
  ],
]);
...
function extractShardDocument(shard, relativePath, errors) {
  const document =
    shard.document ?? (Array.isArray(shard.documents) ? shard.documents[0] : undefined);
...
export function loadManualChunkCorpus(root = defaultRoot) {
  ...
  chunks.sort(
    (a, b) => (a.order ?? 0) - (b.order ?? 0) || String(a.chunkId).localeCompare(String(b.chunkId)),
  );
...
function sourceHeadingRuForChunk(chunk) {
  ...
  const shortHeading =
    firstContentLine.length > 92 ? `${firstContentLine.slice(0, 89)}...` : firstContentLine;
...
export function buildManualManifest(root = defaultRoot) {
  ...
  const reusedApprovedChunkPages = pages.filter(
    (page) => page.translation.status === "reused_primary_source_chunk",
  ).length;
  const manualVisualTextPages = pages.filter(
...
function manualTranslationFingerprint(manifest) {
  return sha256Text(
    (manifest.pages ?? [])
      .map(
        (page) =>
          `${page.pageNumber}:${normalizeManualLayoutText(page.translation?.fullTranslationRu)}`,
      )
...
function manualSourceIndexFingerprint(manifest) {
  return sha256Text(
    [12, 13]
      .map((pageNumber) =>
        normalizeManualLayoutText(manifest.pages?.[pageNumber - 1]?.translation?.fullTranslationRu),
      )
      .join("\n"),
  );
}
...
function pageLayoutKind(pageNumber) {
  if ([1, 14, 21, 43, 57, 89, 98, 104, 123, 152, 184, 199, 200].includes(pageNumber))
...
function textBlockType(line, pageNumber, index, lines) {
  ...
  if (index <= 2 && (trimmed === trimmed.toLocaleUpperCase("ru-RU") || trimmed.length <= 72))
    return "heading";
  if (index > 0 && trimmed.length <= 82 && !/[.!?]$/u.test(trimmed) && /^[\p{Lu}\d]/u.test(trimmed))
    return "heading";
...
function blockMinHeight(block) {
  ...
  if (block.type === "tableCell" || block.type === "caption" || block.type === "label")
    return 0.026;
...
function allocateWeightedHeights(blocks, frameHeight, gap) {
  ...
  return blocks.map((block, index) =>
    roundLayoutUnit(minimums[index] + ((available - minimumTotal) * weights[index]) / weightTotal),
  );
}
...
function blockFrameAdjustments(block, frame) {
  ...
  if (block.type === "heading" && frame.width > 0.34)
    return { x: frame.x, width: frame.width * 0.94 };
...
function positionBlockStack(blocks, frame, gap = 0.007) {
  ...
  blocks.forEach((block, index) => {
    ...
    positioned.push({
      ...block,
      bounds: layoutBounds(adjusted.x, y, adjusted.width, heights[index]),
    });
    y += heights[index] + gap;
  });
  return positioned;
...
function splitBlocksIntoColumns(blocks, columnCount) {
  ...
  for (const block of blocks) {
    ...
    if (
      ...
      current.length > 0 &&
      currentWeight + blockWeight > target * (columns.length + 1)
    ) {
...
function blockFontScale(block, bounds) {
  ...
  const density =
    manualBlockDisplayText(block).length / Math.max(bounds.width * bounds.height * 10000, 1);
...
function finalizeLayoutBlocks(blocks, page) {
  return blocks.map((block) => ({
    ...
    typography: {
      role:
        block.type === "heading" || block.type === "callout" || block.type === "label"
          ? "prominent"
          : "flow",
      fit: "absolute-fit",
    ...
    provenance: {
      ...
      ...(page.translation.chunkProvenance?.chunkId
        ? { sourceChunkId: page.translation.chunkProvenance.chunkId }
        : {}),
      sourceEvidence:
        page.translation.status === "manual_visual_text"
          ? "manual_visual_label_translation"
          : "approved_primary_source_chunk",
    },
  }));
}
...
function leadingBlockCount(kind, blocks) {
  if (kind === "section-divider")
    return blocks.length <= 4 ? blocks.length : Math.min(3, blocks.length);
  ...
  while (
    count < blocks.length &&
    count < 2 &&
    ["heading", "callout", "label"].includes(blocks[count].type)
  )
    count += 1;
  return count;
}
...
function pageTextFrames(kind, page, positionedBlocks) {
  ...
  for (const block of textBlocks) {
    ...
    if (!cluster) {
      cluster = {
        x: block.bounds.x,
        y: block.bounds.y,
        right: block.bounds.x + block.bounds.width,
  ...
  return clusters
    ...
    .map((cluster, index) => ({
      ...
      bounds: expandLayoutBounds(
        layoutBounds(cluster.x, cluster.y, cluster.right - cluster.x, cluster.bottom - cluster.y),
        0.006,
        0.006,
      ),
...
function visualRegionsForPage(kind, page, positionedBlocks, usesTwoColumns) {
  ...
  if (kind === "visual-heavy") {
    const visualRegionBoundsByPage = new Map([
      ...
      [
        186,
        [
          layoutBounds(0.327, 0.315, 0.375, 0.19),
          layoutBounds(0.327, 0.565, 0.375, 0.09),
          layoutBounds(0.327, 0.735, 0.2, 0.07),
        ],
      ],
      ...
      [
        188,
        [
          layoutBounds(0.327, 0.335, 0.375, 0.11),
          layoutBounds(0.327, 0.51, 0.375, 0.08),
          layoutBounds(0.327, 0.64, 0.375, 0.08),
          layoutBounds(0.327, 0.765, 0.375, 0.07),
        ],
      ],
    ...
    const regionBounds = visualRegionBoundsByPage.get(page.pageNumber) ?? [
      layoutBounds(0.327, 0.335, 0.375, 0.4),
    ];
    return [
      ...
      {
        id: `${pageId}-footer-composition`,
        type: "page-footer-branding",
        bounds: layoutBounds(0.17, 0.92, 0.66, 0.035),
        preservedFrom,
      },
    ];
  }
  if (kind === "section-divider") {
    return [
      {
        id: `${pageId}-section-art-band`,
        type: "section-divider-visual-band",
        bounds: layoutBounds(0.14, 0.13, 0.72, 0.14),
        preservedFrom,
      },
      {
        id: `${pageId}-section-footer`,
        type: "page-footer-branding",
        bounds: layoutBounds(0.18, 0.86, 0.64, 0.06),
        preservedFrom,
      },
    ];
  }
  if (kind === "index" || usesTwoColumns) {
    ...
    return [
      {
        id: `${pageId}-column-gutter`,
        type: "column-gutter-and-source-rules",
        bounds: layoutBounds(0.486, gutterY, 0.028, 0.87 - gutterY),
        preservedFrom,
      },
      {
        id: `${pageId}-footer-composition`,
        type: "page-footer-branding",
        bounds: layoutBounds(0.17, 0.925, 0.66, 0.032),
        preservedFrom,
      },
    ];
  }
  return [
    {
      id: `${pageId}-left-margin-context`,
      type: "margin-icons-or-page-chrome",
      bounds: layoutBounds(0.075, 0.18, 0.07, 0.64),
      preservedFrom,
    },
    {
      id: `${pageId}-right-margin-context`,
      type: "margin-icons-or-page-chrome",
      bounds: layoutBounds(0.855, 0.18, 0.07, 0.64),
      preservedFrom,
    },
    {
      id: `${pageId}-footer-composition`,
      type: "page-footer-branding",
      bounds: layoutBounds(0.18, 0.925, 0.64, 0.032),
      preservedFrom,
    },
  ];
}
...
function sourceMask(page, slug, role, bounds, sourceTextEs, opacity = 0.995) {
  return {
    ...
    role,
    sourceGeometry:
      role === "sign-caption" ? "source_page_caption_region" : "source_page_text_region",
    bounds,
    fill: "#fffdf8",
    opacity,
    sourceTextEs,
...
function structuredSourceMaskFromBlock(page, block) {
  return {
    ...
    bounds: expandLayoutBounds(
      block.bounds,
      block.type === "pageNumber" ? 0.002 : 0.004,
      block.type === "pageNumber" ? 0.0015 : 0.003,
    ),
    fill: "#fffdf8",
...
function appendixIVSourceTextMasksForPage(page) {
  ...
  const headingMasksByPage = new Map([
    ...
    [
      186,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.524, 0.694], {
        x: 0.292,
        width: 0.43,
      }),
    ],
    [
      187,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.306], { x: 0.292, width: 0.49 }),
    ],
    [
      188,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.476, 0.606, 0.734], {
        x: 0.292,
        width: 0.49,
      }),
    ],
    [
      189,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.306], { x: 0.292, width: 0.45 }),
    ],
    [
      190,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279], {
        x: 0.292,
        width: 0.5,
        height: 0.036,
      }),
    ...
    [
      193,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.306, 0.675], {
        x: 0.292,
        width: 0.5,
      }),
    ],
    [
      194,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.445, 0.64], {
        x: 0.292,
        width: 0.5,
      }),
    ],
    [
      195,
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279, 0.306, 0.614], {
        x: 0.292,
        width: 0.5,
      }),
    ],
  ...
  const captionMasksByPage = new Map([
    [
      185,
      appendixIVCaptionStripMasks(page, [0.363, 0.418, 0.475, 0.532, 0.604, 0.682], {
        x: 0.327,
        width: 0.375,
        height: 0.03,
      }),
    ...
    [
      186,
      appendixIVCaptionStripMasks(page, [0.343, 0.402, 0.474, 0.53, 0.6, 0.77], {
        x: 0.327,
        width: 0.375,
        height: 0.034,
      }),
    ...
    [
      187,
      appendixIVCaptionStripMasks(page, [0.365, 0.428, 0.493, 0.558, 0.625, 0.706], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      188,
      appendixIVCaptionStripMasks(page, [0.368, 0.43, 0.54, 0.668, 0.795], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      189,
      appendixIVCaptionStripMasks(page, [0.365, 0.43, 0.495, 0.56, 0.625], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      190,
      appendixIVCaptionStripMasks(page, [0.365, 0.43, 0.495, 0.56, 0.625, 0.69], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      191,
      appendixIVCaptionStripMasks(page, [0.365, 0.43, 0.495, 0.62, 0.685], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      193,
      appendixIVCaptionStripMasks(page, [0.365, 0.425, 0.486, 0.548, 0.608, 0.735], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      194,
      appendixIVCaptionStripMasks(page, [0.365, 0.49, 0.558, 0.692, 0.755], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      195,
      appendixIVCaptionStripMasks(page, [0.365, 0.43, 0.49, 0.675, 0.735], {
        x: 0.327,
        width: 0.375,
        height: 0.032,
      }),
    ...
    [
      197,
      appendixIVCaptionStripMasks(page, [0.347, 0.705, 0.842], {
        x: 0.35,
        width: 0.37,
        height: 0.058,
      }),
  ...
  const paragraphMasksByPage = new Map([
    [
      192,
      [
        ...appendixIVSourceHeadingMasks(page, sourceLines, [0.268], {
          x: 0.29,
          width: 0.46,
          height: 0.035,
        }),
        sourceMask(
          ...
          "paragraph-body",
          "instructional-text",
          layoutBounds(0.285, 0.315, 0.46, 0.45),
    ...
    [
      ...
      [
        sourceMask(
          ...
          "instructional-text",
          layoutBounds(0.265, 0.285, 0.47, 0.17),
          page.translation.sourceTextEs,
          1,
        ),
        sourceMask(
          page,
          "closing-source-number-198",
          "source-heading",
          layoutBounds(0.34, 0.53, 0.075, 0.055),
          "198",
          1,
        ),
        sourceMask(
          page,
          "closing-source-number-199",
          "source-heading",
          layoutBounds(0.58, 0.53, 0.075, 0.055),
          "199",
          1,
        ),
      ],
  ...
  return [
    pageNumberMask,
    ...(paragraphMasksByPage.get(page.pageNumber) ??
      headingMasksByPage.get(page.pageNumber) ??
      appendixIVSourceHeadingMasks(page, sourceLines, [0.279])),
...
function sourceTextMasksForBlocks(page, blocks, kind) {
  ...
  return positionManualLayoutBlocks(sourcePage, kind).map((block) =>
    structuredSourceMaskFromBlock(page, block),
  );
}
...
function positionManualLayoutBlocks(page, kind) {
  ...
  if (kind === "visual-heavy") {
    const framesByPage = new Map([
      ...
      [
        186,
        [
          layoutBounds(0.292, 0.279, 0.42, 0.033),
          layoutBounds(0.292, 0.524, 0.42, 0.033),
          layoutBounds(0.292, 0.694, 0.42, 0.033),
        ],
      ],
      ...
      [
        188,
        [
          layoutBounds(0.292, 0.279, 0.48, 0.033),
          layoutBounds(0.292, 0.476, 0.48, 0.03),
          layoutBounds(0.292, 0.606, 0.48, 0.03),
          layoutBounds(0.292, 0.734, 0.48, 0.03),
        ],
      ],
      ...
      [
        193,
        [
          layoutBounds(0.292, 0.279, 0.42, 0.026),
          layoutBounds(0.292, 0.31, 0.42, 0.024),
          layoutBounds(0.292, 0.675, 0.5, 0.033),
        ],
      ],
      [
        194,
        [
          layoutBounds(0.292, 0.279, 0.42, 0.033),
          layoutBounds(0.292, 0.445, 0.42, 0.033),
          layoutBounds(0.292, 0.64, 0.42, 0.033),
        ],
      ],
      [
        195,
        [
          layoutBounds(0.292, 0.31, 0.48, 0.024),
          layoutBounds(0.292, 0.279, 0.48, 0.026),
          layoutBounds(0.292, 0.614, 0.48, 0.03),
        ],
      ],
      ...
      [
        ...
        [
          layoutBounds(0.292, 0.31, 0.48, 0.024),
          layoutBounds(0.292, 0.279, 0.48, 0.026),
          layoutBounds(0.292, 0.536, 0.48, 0.033),
          layoutBounds(0.372, 0.615, 0.42, 0.033),
        ],
      ],
      [
        198,
    ...
    if (frames) {
      ...
      const bodyFrame =
        page.translation.fullTranslationRu.length > 500
          ? layoutBounds(0.19, 0.665, 0.62, 0.2)
          : layoutBounds(0.24, 0.69, 0.52, 0.13);
  ...
  if (kind === "index") {
    if (leadingDrafts.length > 0)
      positioned.push(
        ...positionBlockStack(leadingDrafts, layoutBounds(0.2, 0.14, 0.6, 0.055), 0.006),
      );
    ...
    columns.forEach((column, index) =>
      positioned.push(...positionBlockStack(column, frames[index], 0.0048)),
    );
    return finalizeLayoutBlocks(
      positioned.sort((a, b) => a.order - b.order),
      page,
  ...
  if (leadingDrafts.length > 0)
    positioned.push(
      ...positionBlockStack(leadingDrafts, layoutBounds(0.19, 0.13, 0.62, leadFrameHeight), 0.008),
    );
  const bodyStart =
    leadingDrafts.length > 0
      ? 0.13 + leadFrameHeight + 0.018
      : kind === "front-matter"
        ? 0.19
        : 0.13;
  const bodyFrameHeight =
    kind === "front-matter" ? 0.68 - (bodyStart - 0.19) : 0.79 - (bodyStart - 0.13);
  const usesTwoColumns = shouldUseTwoColumns(kind, page, bodyDrafts);
  if (usesTwoColumns) {
    const columns = splitBlocksIntoColumns(bodyDrafts, 2);
    const frames = [
      layoutBounds(0.18, bodyStart, 0.3, bodyFrameHeight),
      layoutBounds(0.525, bodyStart, 0.3, bodyFrameHeight),
    ];
    columns.forEach((column, index) =>
      positioned.push(...positionBlockStack(column, frames[index], 0.006)),
    );
  } else {
    positioned.push(
      ...positionBlockStack(
        bodyDrafts,
        layoutBounds(0.205, bodyStart, 0.59, bodyFrameHeight),
        0.007,
      ),
    );
  }
...
export function buildManualLayoutManifest(manifest = buildManualManifest(defaultRoot)) {
  const pages = manifest.pages.map((page) => {
    ...
    const usesTwoColumns =
      kind === "index" ||
      blocks.some((block) => block.type !== "pageNumber" && block.bounds.x >= 0.5);
    const normalizedTranslation = normalizeManualLayoutText(page.translation.fullTranslationRu);
    const normalizedBlocks = normalizeManualLayoutText(
      blocks.map((block) => block.textRu).join("\n"),
    );
  ...
  return {
    ...
    coverage: {
      ...
      blockTypes: Object.fromEntries(
        [...blockTypeCounts.entries()].sort(([a], [b]) => a.localeCompare(b)),
      ),
    },
    pages,
  };
...
function withChildRanges(entry) {
  const children = (entry.children ?? []).map((child, index, all) => ({
    ...
    endPage:
      child.endPage ??
      (all.slice(index + 1).find((nextChild) => nextChild.startPage > child.startPage)?.startPage ??
        entry.endPage + 1) - 1,
  }));
...
function validateRuntimeManualSurface(errors, root) {
  ...
  const forbiddenPatterns = [
    ...
    {
      pattern: /\bpdfjs\b|\bPDFViewer\b|\bgetDocument\s*\(/u,
      label: "runtime PDF rendering library",
    },
    { pattern: /\bfetch\s*\(/u, label: "runtime fetch" },
    {
      pattern: /https?:\/\/static\.buenosaires\.gob\.ar|https?:\/\/buenosaires\.gob\.ar/iu,
      label: "remote manual URL in runtime code",
    },
  ];
  ...
  const appSource = existsSync(path(root, appSourcePath))
    ? readFileSync(path(root, appSourcePath), "utf8")
    : "";
  ...
  if (topLevelRuntimeManualImport.test(appSource)) {
    errors.push(
      `${appSourcePath}: manual corpus must be loaded through the manual view lazy boundary, not a top-level runtime import.`,
    );
  }
  if (!/import\(["']\.\/data\/manual4Ruedas["']\)/u.test(appSource)) {
    errors.push(
      `${appSourcePath}: manual surface must dynamically import the local manual corpus when the view opens.`,
    );
  }
  if (/manual-page-grid|manual-visual|manual-translation/u.test(appSource)) {
    errors.push(
      `${appSourcePath}: manual primary UI must not reintroduce the side-by-side visual plus translation card selectors.`,
    );
  }
  if (/manual-russian-page-flow/u.test(appSource)) {
    errors.push(
      `${appSourcePath}: manual primary UI must not collapse Russian blocks into a single flow transcript.`,
    );
  }
  if (!/manualBoundsStyle\(block\.bounds\)/u.test(appSource)) {
    errors.push(
      `${appSourcePath}: manual renderer must position each Russian block using block.bounds.`,
    );
  }
}
...
function validateManifestShape(errors, manifest) {
  ...
  if (manifest.schema !== "cabadrive-manual-ru.v1")
    errors.push("Manual manifest schema must be cabadrive-manual-ru.v1.");
  if (manifest.id !== `${MANUAL_DOCUMENT_ID}-ru-complete`)
    errors.push("Manual manifest id is unexpected.");
...
function validateBounds(errors, label, bounds) {
  ...
  for (const key of ["x", "y", "width", "height"]) {
    if (typeof bounds[key] !== "number" || !Number.isFinite(bounds[key]))
      errors.push(`${label}: bounds.${key} must be a finite number.`);
  }
  if (bounds.x < 0 || bounds.y < 0 || bounds.width <= 0 || bounds.height <= 0)
    errors.push(`${label}: bounds must use positive page-relative coordinates.`);
  if (bounds.x + bounds.width > 1.001 || bounds.y + bounds.height > 1.001)
    errors.push(`${label}: bounds must stay inside the page canvas.`);
}
...
function boundsSignature(bounds) {
  return ["x", "y", "width", "height"]
    .map((key) => Number(bounds?.[key] ?? 0).toFixed(3))
    .join(":");
}

function hasUniformSyntheticBlockGeometry(blocks) {
  const textBlocks = blocks.filter(
    (block) => block.type !== "pageNumber" && isPlainObject(block.bounds),
  );
  if (textBlocks.length < 5) return false;
  const sameHorizontalRail = textBlocks.every(
    (block) =>
      closeEnough(block.bounds.x, textBlocks[0].bounds.x) &&
      closeEnough(block.bounds.width, textBlocks[0].bounds.width),
  );
  const sameHeights = textBlocks.every((block) =>
    closeEnough(block.bounds.height, textBlocks[0].bounds.height),
  );
  const ySteps = textBlocks
    .slice(1)
    .map((block, index) => Number((block.bounds.y - textBlocks[index].bounds.y).toFixed(4)));
  const uniformYSteps =
    ySteps.length > 0 && ySteps.every((step) => closeEnough(step, ySteps[0], 0.0035));
  const uniqueBounds = new Set(textBlocks.map((block) => boundsSignature(block.bounds))).size;
  return (
    (sameHorizontalRail && sameHeights && uniformYSteps) ||
    uniqueBounds < Math.ceil(textBlocks.length * 0.65)
  );
}
...
function validateNonGenericLayoutGeometry(errors, label, layoutPage) {
  ...
  if (hasUniformSyntheticBlockGeometry(blocks)) {
    errors.push(
      `${label}: block bounds look like uniform synthetic flow geometry instead of page-specific layout boxes.`,
    );
  }

  if (Array.isArray(layoutPage.textRegions)) {
    const genericFlowRegion = layoutPage.textRegions.find((region) =>
      /flow|scroll/i.test(`${region?.id ?? ""} ${region?.fit ?? ""}`),
    );
    if (
      genericFlowRegion &&
      textBlocks.length >= 4 &&
      textBlocks.every((block) => insideBounds(block.bounds, genericFlowRegion.bounds))
    ) {
      errors.push(
        `${label}: textRegions must not declare a single generic scrolling flow region that contains all text blocks.`,
      );
    }
  }
  ...
  if (Array.isArray(layoutPage.masks)) {
    if (
      layoutPage.masks.length === 1 &&
      textBlocks.length >= 3 &&
      boundsArea(layoutPage.masks[0]?.bounds) > 0.16
    ) {
      errors.push(
        `${label}: masks must be page/block-specific instead of one broad source-text mask.`,
      );
    }
    if (textBlocks.length >= 3 && layoutPage.masks.length < Math.min(textBlocks.length, 3)) {
      errors.push(
        `${label}: masks must provide enough block-specific source-text replacement regions.`,
      );
    }
  }
  ...
  if (Array.isArray(layoutPage.visualRegions)) {
    if (
      layoutPage.visualRegions.length === 1 &&
      isFullPageBounds(layoutPage.visualRegions[0]?.bounds)
    ) {
      errors.push(`${label}: visualRegions must not be one full-page catch-all region.`);
    }
    if (
      layoutPage.visualRegions.length > 0 &&
      layoutPage.visualRegions.every((region) => boundsArea(region?.bounds) > 0.9)
    ) {
      errors.push(
        `${label}: visualRegions must identify meaningful preserved page regions, not full-page catch-all geometry.`,
      );
    }
  }
}
...
const ALLOWED_SOURCE_MASK_GEOMETRIES = new Set([
  "source_page_text_region",
  "source_page_caption_region",
  "source_page_label_region",
]);
const ALLOWED_SOURCE_MASK_METHODS = new Set([
  "structured_source_text_region",
  "curated_source_page_geometry",
  "structured_precomposed_russian_replacement",
]);
const REPRESENTATIVE_NON_APPENDIX_SOURCE_MASK_PAGES = new Map([
  [
    14,
    {
      label: "section-divider introduction page",
      requiredRoles: ["page-number", "source-heading"],
    },
  ],
  [
    24,
    {
      label: "ordinary chapter body page",
      requiredRoles: ["page-number", "source-heading", "source-body"],
    },
  ],
  [
    75,
    {
      label: "ordinary chapter list page",
      requiredRoles: ["page-number", "source-heading", "source-list"],
    },
  ],
  [
    82,
    {
      label: "ordinary chapter callout/body page",
      requiredRoles: ["page-number", "source-body", "source-heading"],
    },
  ],
  [
    114,
    {
      label: "Appendix I mixed list/table-like page",
      requiredRoles: ["page-number", "source-heading", "source-list", "source-footnote"],
    },
  ],
  [
    125,
    {
      label: "Appendix II body/caption page",
      requiredRoles: ["page-number", "source-body", "source-heading"],
    },
  ],
  [
    144,
    {
      label: "Appendix II safe-driving body page",
      requiredRoles: ["page-number", "source-body", "source-heading"],
    },
  ],
]);
...
function validateMaskSourceProvenance(errors, label, layoutPage, manifestPage) {
  ...
  const blockBounds = new Set(
    (Array.isArray(layoutPage.blocks) ? layoutPage.blocks : []).map((block) =>
      boundsSignature(block?.bounds),
    ),
  );
  for (const mask of masks) {
    const maskLabel = `${label}: mask ${mask?.id ?? "(missing id)"}`;
    if (!isNonEmptyString(mask?.role))
      errors.push(`${maskLabel} must record the source text/caption/label role being replaced.`);
    if (!ALLOWED_SOURCE_MASK_GEOMETRIES.has(mask?.sourceGeometry)) {
      errors.push(
        `${maskLabel} must use source text/caption/label geometry, not destination Russian block geometry.`,
      );
    }
    if (!isNonEmptyString(mask?.sourceTextEs))
      errors.push(`${maskLabel} must record hidden Spanish source text/caption/label evidence.`);
    ...
    if (mask?.provenance?.visualAssetPath !== manifestPage?.visualAsset?.localPath) {
      errors.push(
        `${maskLabel} provenance.visualAssetPath must match the local source page visual.`,
      );
    }
    if (
      mask?.sourceGeometry === "russian_block_replacement_region" ||
      mask?.provenance?.method === "destination_russian_block_geometry"
    ) {
    ...
    if (mask?.provenance?.method === "structured_source_text_region") {
      if (!isNonEmptyString(mask?.provenance?.sourceTextPointer))
        errors.push(`${maskLabel} must point to translation.sourceTextEs.`);
      if (
        typeof mask?.provenance?.sourceLineStart !== "number" ||
        typeof mask?.provenance?.sourceLineEnd !== "number"
      ) {
        errors.push(`${maskLabel} must record source line span provenance.`);
      }
      if (!isNonEmptyString(mask?.provenance?.sourceTextSha256))
        errors.push(`${maskLabel} must record source text hash provenance.`);
    }
    if (
      ...
      errors.push(
        `${maskLabel} bounds match a destination Russian block; non-Appendix masks must come from source regions.`,
      );
    }
  }
}
...
function validateRepresentativeNonAppendixSourceMasks(errors, label, layoutPage) {
  ...
  for (const role of expectation.requiredRoles) {
    if (!masks.some((mask) => mask?.role === role)) {
      errors.push(
        `${label}: representative ${expectation.label} must include a ${role} source-region mask.`,
      );
    }
  }
  if (!masks.every((mask) => ALLOWED_SOURCE_MASK_GEOMETRIES.has(mask?.sourceGeometry))) {
    errors.push(
      `${label}: representative ${expectation.label} must use source text/caption/label mask geometry only.`,
    );
  }
  if (!masks.every((mask) => ALLOWED_SOURCE_MASK_METHODS.has(mask?.provenance?.method))) {
    errors.push(
      `${label}: representative ${expectation.label} must record source-region provenance on every mask.`,
    );
  }
}
...
function validateAppendixIVSourceTextMasks(errors, label, layoutPage) {
  ...
  for (const mask of masks) {
    if (
      ...
      errors.push(
        `${label}: Appendix IV masks must be based on source text/caption geometry, not destination Russian block geometry.`,
      );
    }
    if (!isNonEmptyString(mask?.role))
      errors.push(
        `${label}: Appendix IV mask ${mask?.id ?? "(missing id)"} must record a source-text role.`,
      );
    if (!isNonEmptyString(mask?.sourceTextEs))
      errors.push(
        `${label}: Appendix IV mask ${mask?.id ?? "(missing id)"} must record hidden source text/caption evidence.`,
      );
    if (mask?.provenance?.method !== "curated_source_page_geometry") {
      errors.push(
        `${label}: Appendix IV mask ${mask?.id ?? "(missing id)"} must record curated source-page provenance.`,
      );
    }
  }

  for (const point of requiredPoints) {
    const coveringMask = masks.find(
      (mask) => mask?.role === point.role && maskCoversPoint(mask, point),
    );
    if (!coveringMask) {
      errors.push(
        `${label}: missing ${point.role} mask over source ${point.label} at ${point.x.toFixed(3)},${point.y.toFixed(3)}.`,
      );
    }
  }
}
...
function validateManualLayoutManifest(errors, manifest, layout) {
  ...
  if (layout.schema !== LAYOUT_SCHEMA)
    errors.push(`${MANUAL_LAYOUT_PATH}: schema must be ${LAYOUT_SCHEMA}.`);
  if (layout.manualId !== manifest?.id)
    errors.push(`${MANUAL_LAYOUT_PATH}: manualId must match manual.ru.json id.`);
  if (layout.locale !== "ru") errors.push(`${MANUAL_LAYOUT_PATH}: locale must be ru.`);
  if (layout.source?.manualManifestPath !== MANUAL_MANIFEST_PATH)
    errors.push(`${MANUAL_LAYOUT_PATH}: source.manualManifestPath is unexpected.`);
  if (
    layout.source?.translationFingerprint !==
    manualTranslationFingerprint(manifest ?? { pages: [] })
  ) {
  ...
  if (layout.pages.length !== EXPECTED_SOURCE.pageCount) {
    errors.push(
      `${MANUAL_LAYOUT_PATH}: expected ${EXPECTED_SOURCE.pageCount} page layout records, found ${layout.pages.length}.`,
    );
  }
  ...
  for (let index = 0; index < EXPECTED_SOURCE.pageCount; index += 1) {
    ...
    if (!isPlainObject(layoutPage)) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} layout entry must be an object.`,
      );
      continue;
    }
    if (layoutPage.pageNumber !== expectedPageNumber)
      errors.push(`${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} pageNumber is out of order.`);
    if (layoutPage.sourcePageNumber !== expectedPageNumber)
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} sourcePageNumber must match source page.`,
      );
    if (
      layoutPage.canvas?.width !== page?.visualAsset?.width ||
      layoutPage.canvas?.height !== page?.visualAsset?.height
    ) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} canvas must match local visual asset dimensions.`,
      );
    }
    if (layoutPage.visualBase?.localPath !== page?.visualAsset?.localPath) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} visualBase.localPath must match manual visual asset.`,
      );
    }
    if (layoutPage.visualBase?.sha256 !== page?.visualAsset?.sha256) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} visualBase.sha256 must match manual visual asset.`,
      );
    }
    if (!Array.isArray(layoutPage.masks) || layoutPage.masks.length < 1) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} must include at least one source-text replacement mask.`,
      );
    } else {
      layoutPage.masks.forEach((mask, maskIndex) =>
        validateBounds(
          errors,
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} mask ${maskIndex + 1}`,
          mask?.bounds,
        ),
      );
    }
    if (!Array.isArray(layoutPage.visualRegions) || layoutPage.visualRegions.length < 1) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} must include at least one visual preservation region.`,
      );
    } else {
      layoutPage.visualRegions.forEach((region, regionIndex) =>
        validateBounds(
          errors,
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} visual region ${regionIndex + 1}`,
          region?.bounds,
        ),
      );
    }
    if (!Array.isArray(layoutPage.textRegions) || layoutPage.textRegions.length < 1) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} must include at least one Russian text region.`,
      );
    } else {
      layoutPage.textRegions.forEach((region, regionIndex) => {
        validateBounds(
          errors,
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} text region ${regionIndex + 1}`,
          region?.bounds,
        );
        if (region?.fit !== "absolute-positioned-blocks") {
          errors.push(
            `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} text region ${regionIndex + 1} must be absolute-positioned-blocks.`,
          );
        }
      });
    }
    if (!Array.isArray(layoutPage.blocks) || layoutPage.blocks.length < 1) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} must include ordered Russian layout blocks.`,
      );
      continue;
    }
    ...
    layoutPage.blocks.forEach((block, blockIndex) => {
      if (!isPlainObject(block)) {
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} must be an object.`,
        );
        return;
      }
      if (!isNonEmptyString(block.id))
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} id is missing.`,
        );
      if (blockIds.has(block.id))
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block id ${block.id} is duplicated.`,
        );
      blockIds.add(block.id);
      if (block.order !== blockIndex + 1)
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} order is out of sequence.`,
        );
      if (!allowedBlockTypes.has(block.type))
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} has unsupported type ${block.type}.`,
        );
      seenTypes.add(block.type);
      if (!isNonEmptyString(block.textRu))
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} textRu is missing.`,
        );
      if (PLACEHOLDER_PATTERN.test(block.textRu || ""))
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} textRu must not contain placeholder text.`,
        );
      validateBounds(
        errors,
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1}`,
        block.bounds,
      );
      if (block.typography?.fit !== "absolute-fit") {
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} typography.fit must be absolute-fit.`,
        );
      }
      if (
        typeof block.typography?.fontScale !== "number" ||
        !Number.isFinite(block.typography.fontScale)
      ) {
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} typography.fontScale must be numeric.`,
        );
      }
      if (
        typeof block.typography?.lineHeight !== "number" ||
        !Number.isFinite(block.typography.lineHeight)
      ) {
        errors.push(
          `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} block ${blockIndex + 1} typography.lineHeight must be numeric.`,
        );
      }
      orderedText.push(block.textRu);
    });
    validateNonGenericLayoutGeometry(
      errors,
      `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber}`,
      layoutPage,
    );
    validateMaskSourceProvenance(
      errors,
      `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber}`,
      layoutPage,
      page,
    );
    validateRepresentativeNonAppendixSourceMasks(
      errors,
      `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber}`,
      layoutPage,
    );
    validateAppendixIVSourceTextMasks(
      errors,
      `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber}`,
      layoutPage,
    );
    ...
    if (normalizedTranslation !== normalizedBlocks) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} ordered Russian blocks do not reconstruct fullTranslationRu.`,
      );
    }
    if (layoutPage.coverage?.normalizedTranslationSha256 !== normalizedTranslationSha256) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} normalizedTranslationSha256 is stale.`,
      );
    }
    if (layoutPage.coverage?.normalizedBlocksSha256 !== normalizedBlocksSha256) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} normalizedBlocksSha256 is stale.`,
      );
    }
    if (layoutPage.coverage?.blockCount !== layoutPage.blocks.length) {
      errors.push(
        `${MANUAL_LAYOUT_PATH}: page ${expectedPageNumber} coverage.blockCount is stale.`,
      );
    }
  }
  ...
  for (const requiredType of allowedBlockTypes) {
    if (!seenTypes.has(requiredType))
      errors.push(
        `${MANUAL_LAYOUT_PATH}: layout blocks must include type ${requiredType} where present in the manual corpus.`,
      );
  }
  if (layout.coverage?.pages !== layout.pages.length)
    errors.push(`${MANUAL_LAYOUT_PATH}: coverage.pages is stale.`);
  if (layout.coverage?.requiredPages !== EXPECTED_SOURCE.pageCount)
    errors.push(
      `${MANUAL_LAYOUT_PATH}: coverage.requiredPages must be ${EXPECTED_SOURCE.pageCount}.`,
    );
}
...
function validateManualNavigationManifest(errors, manifest, navigation) {
  ...
  if (navigation.schema !== NAVIGATION_SCHEMA)
    errors.push(`${MANUAL_NAVIGATION_PATH}: schema must be ${NAVIGATION_SCHEMA}.`);
  if (navigation.manualId !== manifest?.id)
    errors.push(`${MANUAL_NAVIGATION_PATH}: manualId must match manual.ru.json id.`);
  if (navigation.locale !== "ru") errors.push(`${MANUAL_NAVIGATION_PATH}: locale must be ru.`);
  if (navigation.pageCount !== EXPECTED_SOURCE.pageCount)
    errors.push(`${MANUAL_NAVIGATION_PATH}: pageCount must be ${EXPECTED_SOURCE.pageCount}.`);
  if (navigation.source?.manualManifestPath !== MANUAL_MANIFEST_PATH)
    errors.push(`${MANUAL_NAVIGATION_PATH}: source.manualManifestPath is unexpected.`);
  if (
    navigation.source?.indexTextSha256 !== manualSourceIndexFingerprint(manifest ?? { pages: [] })
  ) {
  ...
  const manualPageByNumber = new Map(
    (manifest?.pages ?? []).map((page) => [page.pageNumber, page]),
  );
  const requiredTopLevel = new Map(
    MANUAL_TOP_LEVEL_NAVIGATION.map((entry) => [
      entry.id,
      {
        ...
        requiredPrintedPage: entry.requiredPrintedPage,
      },
    ]),
  );
  ...
  for (const entry of navigation.entries) {
    ...
    if (!required)
      errors.push(`${MANUAL_NAVIGATION_PATH}: unexpected top-level entry ${entry.id}.`);
    if (required && entry.titleRu !== required.titleRu)
      errors.push(`${MANUAL_NAVIGATION_PATH}: ${entry.id} titleRu is stale.`);
    if (required && entry.startPage !== required.startPage)
      errors.push(
        `${MANUAL_NAVIGATION_PATH}: ${entry.id} startPage must be ${required.startPage}.`,
      );
    if (required && entry.endPage !== required.endPage)
      errors.push(`${MANUAL_NAVIGATION_PATH}: ${entry.id} endPage must be ${required.endPage}.`);
    if (entry.startPage !== expectedStartPage)
      errors.push(
        `${MANUAL_NAVIGATION_PATH}: ${entry.id} leaves a page coverage gap before page ${entry.startPage}.`,
      );
    ...
    if (!["frontMatter", "chapter", "appendix"].includes(entry.level)) {
      errors.push(
        `${MANUAL_NAVIGATION_PATH}: ${entry.id} has unsupported top-level level ${entry.level}.`,
      );
    }
    if (
      entry.sourceEvidence !== "index_pages_11_12" &&
      entry.sourceEvidence !== "curated_manual_review"
    ) {
    ...
    for (const child of entry.children ?? []) {
      if (child.level !== "topic")
        errors.push(`${MANUAL_NAVIGATION_PATH}: child ${child.id} level must be topic.`);
      if (
        child.startPage < entry.startPage ||
        child.endPage > entry.endPage ||
        child.startPage > child.endPage
      ) {
        errors.push(
          `${MANUAL_NAVIGATION_PATH}: child ${child.id} range must stay inside parent ${entry.id}.`,
        );
      }
      if (child.startPage < previousChildStart)
        errors.push(`${MANUAL_NAVIGATION_PATH}: child ${child.id} is out of order.`);
      previousChildStart = child.startPage;
      if (!isNonEmptyString(child.titleRu))
        errors.push(`${MANUAL_NAVIGATION_PATH}: child ${child.id} titleRu is missing.`);
      if (
        child.sourceEvidence !== "index_pages_11_12" &&
        child.sourceEvidence !== "page_heading" &&
        child.sourceEvidence !== "curated_manual_review"
      ) {
      ...
      if (startEvidence) {
        if (child.startPage !== startEvidence.startPage) {
          errors.push(
            `${MANUAL_NAVIGATION_PATH}: child ${child.id} must start on page ${startEvidence.startPage} based on page-heading/content evidence.`,
          );
        }
        const pageText = normalizeManualLayoutText(
          manualPageByNumber.get(child.startPage)?.translation?.fullTranslationRu ?? "",
        );
        for (const requiredText of startEvidence.requiredText) {
          if (!pageText.includes(requiredText)) {
            errors.push(
              `${MANUAL_NAVIGATION_PATH}: child ${child.id} start page ${child.startPage} does not contain required evidence text "${requiredText}".`,
            );
          }
        }
      }
  ...
  if (expectedStartPage !== EXPECTED_SOURCE.pageCount + 1) {
    errors.push(
      `${MANUAL_NAVIGATION_PATH}: top-level entries must cover through page ${EXPECTED_SOURCE.pageCount}.`,
    );
  }

  const flattenedIds = new Set(
    flattenNavigationEntries(navigation.entries).map((entry) => entry.id),
  );
  for (const requiredId of [
    ...
    if (!flattenedIds.has(requiredId))
      errors.push(
        `${MANUAL_NAVIGATION_PATH}: required source-index topic ${requiredId} is missing.`,
      );
  }
}

export async function validateManualVehiculo4RuedasRu({
  root = defaultRoot,
  manifest,
  layout,
  navigation,
  ...
  const loadedManifest =
    manifest ??
    (existsSync(path(root, MANUAL_MANIFEST_PATH))
      ? readJson(root, MANUAL_MANIFEST_PATH)
      : undefined);
  const loadedLayout =
    layout ??
    (existsSync(path(root, MANUAL_LAYOUT_PATH)) ? readJson(root, MANUAL_LAYOUT_PATH) : undefined);
  const loadedNavigation =
    navigation ??
    (existsSync(path(root, MANUAL_NAVIGATION_PATH))
      ? readJson(root, MANUAL_NAVIGATION_PATH)
      : undefined);
  const corpus = loadManualChunkCorpus(root);
  ...
  if (!rawPdfExists) {
    ...
    try {
      ...
      if (pageCount !== EXPECTED_SOURCE.pageCount) {
        errors.push(
          `${EXPECTED_SOURCE.rawOriginalPath}: expected ${EXPECTED_SOURCE.pageCount} pages, found ${pageCount}.`,
        );
      }
    } catch (error) {
      errors.push(
        `${EXPECTED_SOURCE.rawOriginalPath}: could not read PDF page count: ${error.message}`,
      );
    }
  }
  ...
  if (pages.length !== EXPECTED_SOURCE.pageCount) {
    errors.push(
      `Manual manifest must contain ${EXPECTED_SOURCE.pageCount} page entries, found ${pages.length}.`,
    );
  }
  ...
  for (let index = 0; index < EXPECTED_SOURCE.pageCount; index += 1) {
    ...
    if (page.pageNumber !== expectedPageNumber)
      errors.push(`Manual page ${expectedPageNumber}: pageNumber is out of order.`);
    if (page.sourcePageNumber !== expectedPageNumber)
      errors.push(`Manual page ${expectedPageNumber}: sourcePageNumber must match source page.`);
    if (page.sourceTrace?.officialDocumentId !== MANUAL_DOCUMENT_ID) {
      errors.push(
        `Manual page ${expectedPageNumber}: sourceTrace.officialDocumentId is unexpected.`,
      );
    }
    ...
    if (!isPlainObject(asset)) {
      ...
      if (normalizedPath !== expectedAssetPath)
        errors.push(
          `Manual page ${expectedPageNumber}: visualAsset.localPath must be ${expectedAssetPath}.`,
        );
      if (/^https?:\/\//iu.test(normalizedPath))
        errors.push(`Manual page ${expectedPageNumber}: visualAsset.localPath must be local.`);
      if (/\.pdf(?:$|[?#])/iu.test(normalizedPath))
        errors.push(`Manual page ${expectedPageNumber}: visualAsset.localPath must not be a PDF.`);
      if (asset.format !== "jpeg")
        errors.push(`Manual page ${expectedPageNumber}: visualAsset.format must be jpeg.`);
      if (!existsSync(path(root, expectedAssetPath))) {
        ...
        if (!dimensions) {
          ...
          if (asset.width !== dimensions.width)
            errors.push(`${expectedAssetPath}: width mismatch.`);
          if (asset.height !== dimensions.height)
            errors.push(`${expectedAssetPath}: height mismatch.`);
          if (asset.width < 1000 || asset.height < 1400) {
            errors.push(
              `${expectedAssetPath}: rendered dimensions are too small for page-faithful study.`,
            );
          }
        }
        if (asset.sha256 !== actualSha256) errors.push(`${expectedAssetPath}: sha256 mismatch.`);
        if (!SHA256_PATTERN.test(asset.sha256 || ""))
          errors.push(`${expectedAssetPath}: sha256 must be a lowercase SHA-256 hash.`);
      }
    }
    ...
    if (!translation.exactCoverage)
      errors.push(`Manual page ${expectedPageNumber}: translation.exactCoverage must be true.`);
    if (!isNonEmptyString(translation.fullTranslationRu))
      errors.push(`Manual page ${expectedPageNumber}: fullTranslationRu is missing.`);
    if (!isNonEmptyString(translation.sourceTextEs))
      errors.push(`Manual page ${expectedPageNumber}: sourceTextEs is missing.`);
    if (PLACEHOLDER_PATTERN.test(translation.fullTranslationRu || "")) {
      errors.push(
        `Manual page ${expectedPageNumber}: fullTranslationRu must not contain placeholder text.`,
      );
    }
    ...
    if (translation.status === "reused_primary_source_chunk") {
      ...
      if (!chunk)
        errors.push(
          `Manual page ${expectedPageNumber}: reused chunk with order ${expectedPageNumber} is missing.`,
        );
      if (expectedPageNumber > 198)
        errors.push(
          `Manual page ${expectedPageNumber}: only pages 1-198 may reuse approved primary-source chunks.`,
        );
      if (chunk && provenance?.chunkId !== chunk.chunkId)
        errors.push(`Manual page ${expectedPageNumber}: chunk provenance id mismatch.`);
      if (chunk && translation.fullTranslationRu !== chunk.fullTranslationRu) {
        errors.push(
          `Manual page ${expectedPageNumber}: reused fullTranslationRu must match the approved chunk exactly.`,
        );
      }
      if (chunk && translation.sourceTextEs !== chunk.originalSpanish) {
        errors.push(
          `Manual page ${expectedPageNumber}: reused sourceTextEs must match the approved chunk exactly.`,
        );
      }
      if (qaRecord?.translationQa?.status !== "approved") {
        errors.push(
          `Manual page ${expectedPageNumber}: reused chunk translation QA must be approved.`,
        );
      }
      if (qaRecord?.simplificationQa?.status !== "approved") {
        errors.push(
          `Manual page ${expectedPageNumber}: reused chunk simplification QA must be approved.`,
        );
      }
      if (
        !isNonEmptyString(provenance?.shardPath) ||
        !MANUAL_CHUNK_SHARDS.includes(provenance.shardPath)
      ) {
        errors.push(
          `Manual page ${expectedPageNumber}: reused chunk shard provenance is missing or unexpected.`,
        );
      }
      if (
        !isNonEmptyString(provenance?.qaShardPath) ||
        !MANUAL_QA_SHARDS.includes(provenance.qaShardPath)
      ) {
        errors.push(
          `Manual page ${expectedPageNumber}: reused chunk QA shard provenance is missing or unexpected.`,
        );
      }
      ...
      if (!SUPPLEMENTAL_VISUAL_TEXT.has(expectedPageNumber)) {
        errors.push(
          `Manual page ${expectedPageNumber}: manual visual-text translation is only allowed for final visual-only pages.`,
        );
      }
      if (translation.sourceTextCoverage !== "visual_label_text") {
        errors.push(
          `Manual page ${expectedPageNumber}: manual visual-text pages must use sourceTextCoverage visual_label_text.`,
        );
      }
      if (
        translation.visualTextTranslationProvenance?.featureId !== "027-manual-vehiculo-4ruedas-ru"
      ) {
        errors.push(
          `Manual page ${expectedPageNumber}: manual visual-text provenance must reference feature 027.`,
        );
      }
    } else {
      errors.push(
        `Manual page ${expectedPageNumber}: unsupported translation status ${translation.status}.`,
      );
    }
  }

  if (reusedApprovedChunkPages !== 198)
    errors.push(
      `Manual translation reuse must cover 198 approved chunk pages, found ${reusedApprovedChunkPages}.`,
    );
  if (manualVisualTextPages !== 2)
    errors.push(
      `Manual visual-label translations must cover 2 final pages, found ${manualVisualTextPages}.`,
    );
  if (loadedManifest?.translationCoverage?.omittedPages !== 0)
    errors.push("Manual translationCoverage.omittedPages must be 0.");
  ...
  return {
    ...
    summary: {
      ...
      navigationEntries: Array.isArray(loadedNavigation?.entries)
        ? loadedNavigation.entries.length
        : 0,
      navigationTopics: Array.isArray(loadedNavigation?.entries)
        ? flattenNavigationEntries(loadedNavigation.entries).length -
          loadedNavigation.entries.length
        : 0,
      reusedApprovedChunkPages,
      manualVisualTextPages,
