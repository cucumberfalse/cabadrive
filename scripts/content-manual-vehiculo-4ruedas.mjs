...
const MANUAL_TOP_LEVEL_NAVIGATION = [
  {
    ...
    children: [
      { id: "front-title", titleRu: "Титульная страница", titleEs: "Portada", startPage: 1, endPage: 1, sourceEvidence: "page_heading" },
      { id: "front-presentation", titleRu: "Презентация", titleEs: "Presentación", startPage: 2, endPage: 2, sourceEvidence: "page_heading" },
      { id: "front-categories", titleRu: "Материал по категориям", titleEs: "Material por categorías", startPage: 3, endPage: 4, sourceEvidence: "page_heading" },
      { id: "front-glossary", titleRu: "Глоссарий", titleEs: "Glosario", startPage: 5, endPage: 11, sourceEvidence: "page_heading" },
      { id: "front-index", titleRu: "Индекс", titleEs: "Índice", startPage: 12, endPage: 13, sourceEvidence: "index_pages_11_12" }
    ]
  },
  {
    id: "introduction",
