  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Если дорожная непредвиденная ситуация полностью исключает движение через Paseo del Bajo, источник допускает исключительные маршруты для тяжелых грузовиков и прицепов с индивидуальной массой 12 t или больше, с грузом или без него, а также для междугородних автобусов с пассажирами или без.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Если руль становится тяжелым, нестабильным или появляются необычные шумы, источник рекомендует проверку в мастерской.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Для крупногабаритного транспорта источник рекомендует замену уже при 2 mm.",
        "Рисунок отводит воду из зоны контакта и помогает избежать aquaplaning.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "С восьмого месяца беременности источник рекомендует, чтобы управлял другой человек.",
    ...
    },
    {
      ...
      kind: "list",
      titleRu: "Airbag, бамперы, стекла и кабина",
      sourceTextEs:
      ...
      itemsRu: [
        "Airbag дополняет ремень безопасности, но не заменяет его; без ремня airbag может вызвать тяжелые травмы.",
        "Airbag безопасен при минимальной дистанции 25 cm от тела до зоны раскрытия.",
