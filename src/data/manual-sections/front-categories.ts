...
export const frontCategoriesSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      captionRu:
        "Для Cabadrive основной маршрут подготовки остается категорией B; остальные строки помогают понять структуру полного руководства."
    },
    {
      ...
      textRu:
        "Практический вывод: если вы готовитесь на обычный автомобиль, не смешивайте Приложения II/III (Appendix II/III) с основным маршрутом B. В `Руководстве` они доступны как части полного руководства, но для категории B ключевой дополнительный материал - Приложение I (Appendix I) и дорожные знаки Приложения IV (Appendix IV)."
    }
  ]
};
