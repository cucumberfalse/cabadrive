  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Bitren (двухзвенный автопоезд) состоит из одного тягача и двух би-сочлененных полуприцепов.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Также нужны RUTA, сертификат RTO, LiNTI при межюрисдикционной перевозке, документ на груз: remito (товарная накладная), carta de porte (транспортная накладная), guia (путевой/сопроводительный документ) или factura (счет-фактура).",
