...
export const app2SocialResponsibilitySection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      textRu:
        "Главный вывод источника: водитель пассажирского транспорта играет ключевую роль на общественной дороге, потому что его решения напрямую влияют на безопасность пассажиров и других участников движения."
    }
  ]
};
