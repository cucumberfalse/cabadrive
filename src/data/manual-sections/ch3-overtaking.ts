...
export const ch3OvertakingSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      textRu:
        "Статья 42 Ley 24449 дополняет правило adelantamiento: маневр выполняют только там, где он разрешен и безопасен, заранее предупреждают, соблюдают дистанцию и возвращаются вправо без мешающего или опасного движения."
    }
  ]
};
