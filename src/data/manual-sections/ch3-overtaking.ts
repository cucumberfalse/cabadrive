  ...
  blocks: [
    {
      ...
      itemsRu: [
        "Adelantamiento - маневр, при котором транспортное средство проходит линию другого движущегося транспортного средства и для этого обычно меняет полосу.",
        "Sobrepaso - прохождение мимо другого транспортного средства без необходимости менять полосу, например когда полосы идут в одном направлении.",
    ...
    },
    {
      ...
      textRu:
        "Источник дополнительно ссылается на статью 42 Ley 24449: при adelantamiento нужно выполнять маневр только там, где он разрешен и безопасен, заранее предупредить, соблюдать дистанцию и вернуться вправо без мешающего или опасного движения."
    }
  ]
};
