...
export const ch2IncidentObligationsSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      textRu:
        "Граница источника: на странице 55 после списка НКО начинается отдельный раздел Scoring. Он вынесен в следующую страницу сайта `Система баллов Scoring`, чтобы не смешивать обязанности после инцидента с системой баллов."
    }
  ]
};
