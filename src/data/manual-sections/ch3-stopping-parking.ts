  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "В Metrobús у обеих aceras (тротуаров/бордюров) каждый день 24 часа.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "В Macrocentro запрет парковки у обеих aceras (тротуаров/бордюров) действует для любой arteria (дороги/артерии) в рабочие дни с 7 до 21 часа.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Ómnibus, micros, camiones, casas rodantes, semiacoplados и maquinaria especial (автобусы, микроавтобусы, грузовики, дома на колесах, полуприцепы и спецтехника) не могут парковаться на общественной дороге 24 часа."
      ]
    },
    {
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Грузовые автомобили дополнительно используют cuñas или calzas (противооткатные упоры/клинья) и после использования убирают их с общественной дороги.",
