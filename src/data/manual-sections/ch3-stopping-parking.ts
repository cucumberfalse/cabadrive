  ...
  blocks: [
    {
      ...
      textRu:
        "Detención - это пребывание автомобиля без движения у бордюра только на строго необходимое время: контроль движения компетентным органом, посадка или высадка пассажиров, погрузка или разгрузка. При другой причине это считается detención, если длится не более 2 минут и водитель не покидает автомобиль."
    },
    {
      id: "detention-method",
      kind: "list",
      titleRu: "Как выполнять detención",
      sourceTextEs:
        "Se realiza siempre con balizas intermitentes encendidas, situando el vehículo lo más cerca posible de la acera...",
      itemsRu: [
        "Всегда с включенными balizas intermitentes.",
        "Поставить автомобиль как можно ближе к acera.",
        "Принять меры, чтобы не мешать движению.",
        "Остановка из-за светофора, пробки, дорожной ситуации или силы majeure не считается detención или estacionamiento."
      ]
    },
    {
      id: "detention-prohibitions",
      kind: "list",
      titleRu: "Где запрещена detención",
      sourceTextEs:
        "Está prohibido detenerse en... también aplica a los vehículos con emblema internacional de discapacidad.",
      itemsRu: [
        "В секторах остановки colectivos и taxis.",
        "Перед comisarías, пожарными частями и банками, кроме транспорта, который обслуживает эти учреждения.",
        "На ciclovías.",
        "На vías rápidas: Av. Cantilo, Av. Lugones, центральные проезжие части Gral. Paz и autopistas.",
        "Во второй ряд, кроме краткой остановки прямо перед маневром парковки.",
        "На углах.",
        "На пешеходных переходах или линиях Pare.",
        "На въезде, внутри и выезде из тоннелей, pasos bajo nivel и мостов.",
    ...
    },
    {
      ...
      textRu:
        "Estacionamiento - это пребывание автомобиля без движения на общественной дороге дольше времени, нужного для detención, то есть больше 2 минут. Неважно, есть ли водитель, работает ли двигатель, включены ли balizas и находятся ли люди внутри."
    },
    {
      ...
      itemsRu: [
        "На avenidas у обеих aceras в рабочие дни с 7 до 21 часа.",
        "В Metrobús у обеих aceras каждый день 24 часа.",
        "На ciclovías со стороны затронутой полосы каждый день 24 часа.",
        "В pasajes с шириной проезжей части не более 4,5 м.",
        "На calles de convivencia по всей длине у обеих aceras.",
    ...
    },
    {
      ...
      itemsRu: [
        "На двусторонних avenidas Av. 9 de Julio, Av. Perito Moreno и центральных проезжих частях Av. Leandro N. Alem, Paseo Colón и Sáenz запрет действует 24 часа.",
        "В Macrocentro запрет парковки у обеих aceras действует для любой arteria в рабочие дни с 7 до 21 часа.",
        "На calles парковка у обеих aceras разрешена каждый день 24 часа, если знак не указывает другое.",
        "На avenidas парковка разрешена с 21 до 7 часов у обеих сторон в рабочие дни, а также 24 часа в выходные и праздники, если знак не указывает другое."
      ]
    },
    {
      ...
      itemsRu: [
        ...
        "Motovehículos: на тротуаре и проезжей части только в специально размеченных секторах.",
        "Если специальной разметки нет, motovehículos ставятся задней частью к бордюру под 45-90 градусов и соблюдают те же нормы, что остальные транспортные средства."
      ]
    },
    {
      id: "special-parking-prohibitions",
      kind: "list",
      titleRu: "Специальные запреты estacionamiento",
      sourceTextEs:
        "Prohibiciones especiales... deben respetarse haya o no una señal.",
      itemsRu: [
        "В местах, где уже запрещена detención.",
        "В pasajes шириной не более 4,5 м и на calles de convivencia у обеих aceras.",
        "Ближе 50 м с каждой стороны от железнодорожного переезда на уровне.",
        "В секторах въезда и выезда автомобилей на дорогу, то есть у garajes.",
        "Перед rampas для людей с инвалидностью.",
        "Перед входами в subterráneos.",
        "Перед входами в места публичных зрелищ в часы функций.",
        "Перед входом в salas velatorias с 8 до 22 часов.",
        "Там, где есть carriles exclusivos для определенного транспорта в часы их действия.",
        ...
        "В официально обозначенных секторах: carga y descarga, hoteles, ferias barriales, резерв парковки, запрет парковки и подобные случаи.",
        "Ómnibus, micros, camiones, casas rodantes, semiacoplados и maquinaria especial не могут парковаться на общественной дороге 24 часа."
      ]
    },
    {
      ...
      itemsRu: [
        ...
        "Это относится и к motovehículos независимо от ширины тротуара или механической неисправности.",
        ...
        "О намерении остановиться, припарковаться или въехать в гараж нужно заранее сообщать balizas, маневрировать без толкания других автомобилей, без заезда на acera и с контролем через зеркала."
      ]
    },
    {
      id: "slopes-loading-disability",
      kind: "list",
      titleRu: "Уклон, carga y descarga и franquicia",
      sourceTextEs:
      ...
      itemsRu: [
        ...
        "На подъеме повернуть колеса к центру проезжей части и оставить первую передачу или режим parking для автоматической коробки.",
        "На спуске повернуть колеса к бордюру и оставить заднюю передачу или режим parking.",
        "Грузовые автомобили дополнительно используют cuñas или calzas и после использования убирают их с общественной дороги.",
        "Carga y descarga выполняется с включенными balizas, строго в местах и в часы, которые устанавливают правила парковки, если специальные сектора не указывают другое.",
        "Cajones azules обозначены синей или сине-белой линией и предназначены только для погрузки/разгрузки. Максимум - 30 минут, если знак не указывает другое; частные автомобили там не паркуются.",
        "Símbolo Internacional de Acceso идентифицирует любой автомобиль, перевозящий человека с инвалидностью. В CABA franquicia позволяет парковаться у обеих aceras улиц и avenidas в общем случае, но не отменяет специальные запреты и не разрешает мешать движению или безопасности."
      ]
    },
    {
      id: "chapter-closing",
