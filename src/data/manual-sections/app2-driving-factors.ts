  ...
  blocks: [
    {
      ...
      textRu:
        "Повторяя один и тот же маршрут каждый день, профессиональный водитель может почувствовать, что все под контролем. Но дорожные ситуации не одинаковы, а излишняя уверенность вместе с длинной сменой требует предупредительного вождения."
    },
    {
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Во время остановок полезны упражнения для ног, стоп, шеи, рук, спины и обычная ходьба."
      ]
    },
    {
      ...
      itemsRu: [
        ...
        "Базовые рекомендации: здоровый завтрак, меньше сахара, меньше жирной и переработанной еды, больше фруктов, овощей, бобовых, цельных злаков и орехов, разнообразное питание, не переедать, пить воду и заниматься физической активностью.",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "С человеком с интеллектуальной инвалидностью нужно говорить просто, но не инфантилизировать разговор; если не поняли, сказать то же другими словами."
      ]
    },
    {
      id: "taxi-rules",
