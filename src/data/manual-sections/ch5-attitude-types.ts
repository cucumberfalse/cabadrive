  ...
  blocks: [
    {
      ...
      textRu:
        "Хорошее вождение зависит не только от пригодности человека: недостаточно иметь знания, навыки и психофизическое состояние, позволяющее управлять. Есть еще третий аспект - actitud (установка или отношение): способ чувствовать и думать, который предрасполагает к положительному или отрицательному поведению."
    },
    {
