  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Если одновременно действует несколько исключений, приоритет определяется в том порядке, в котором они перечислены в источнике."
      ]
    },
    {
      id: "artery-hierarchy",
      ...
      textRu:
        "Если пересекаются дороги разных категорий, преимущество у транспорта на более важной артерии. Иерархия из источника: avenida выше calle, calle выше pasaje."
    },
    {
