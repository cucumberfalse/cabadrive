  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Для частных автомобилей и мототранспортных средств VTV действует 2 года до восьмого года или до 80 000 км, затем ежегодно. После первого прохождения срок становится ежегодным.",
