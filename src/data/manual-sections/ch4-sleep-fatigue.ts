...
export const ch4SleepFatigueSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      textRu:
        "Если человек спит недостаточно, организм пытается вернуть равновесие: в последующие дни растет потребность во сне и снижается работоспособность. Усталость может усиливаться от алкоголя и обильной еды."
    },
    {
    ...
    },
    {
      ...
      itemsRu: [
        "Перед длинной поездкой выспаться: ориентир - примерно 8 часов сна предыдущей ночью.",
        "Прерывать поездку каждые 200 км или каждые 2 часа.",
        "Для водителей motovehículos (мототранспорта) остановки нужны чаще: каждые 100 км или каждый 1 час.",
