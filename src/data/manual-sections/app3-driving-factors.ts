      ...
      cards: [
        {
          ...
          termTranslations: [
            { termEs: "Brazos", translationRu: "Руки: держать руль на удобной высоте, с расслабленными плечами." },
            { termEs: "Piernas", translationRu: "Ноги: не выпрямлять полностью; сохранять небольшой изгиб для работы педалями." },
            { termEs: "Cabeza y espalda", translationRu: "Голова и спина: опираться на сиденье и подголовник, держать спину поддержанной." },
            { termEs: "El asiento", translationRu: "Сиденье: отрегулировать под тело и не держать его слишком низко." }
          ],
          bodyRu:
