  ...
  blocks: [
    {
      ...
      textRu:
        "Sistema de Evaluación Permanente de Conductores (постоянная система оценки водителей), или Scoring (система баллов), присваивает каждому человеку с водительским удостоверением баллы. При первом получении лицензии дается 20 баллов; затем из этой базы списываются баллы в зависимости от вида нарушения."
    },
    {
      id: "recover-points",
      kind: "list",
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Вместо лицензии выдается Boleta de Citación (повестка/талон вызова), которая разрешает управлять максимум 3 рабочих дня.",
