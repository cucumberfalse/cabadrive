...
export const ch3PriorityOfRulesSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        "1. Сигналы и распоряжения контролирующего органа: agentes de tránsito (дорожные агенты), Policía de la Ciudad, уполномоченный персонал работ на дороге и железнодорожный персонал в соответствующей зоне.",
