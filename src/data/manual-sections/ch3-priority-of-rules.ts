...
export const ch3PriorityOfRulesSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        "1. Сигналы и распоряжения контролирующего органа: agentes de tránsito, Policía de la Ciudad, уполномоченный персонал работ на дороге и железнодорожный персонал в соответствующей зоне.",
    ...
    },
    {
      ...
      textRu:
        "Указание контролирующего органа выше любой нормы или знака. В CABA Cuerpo de Agentes de Tránsito отвечает, среди прочего, за организацию движения и контроль соблюдения действующих правил."
    },
    {
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Специальные марки включают стрелки, Ceda el paso, железнодорожный переезд, эксклюзивную и аварийную полосу, Pare, направляющие островки, разметку для тумана и другие специальные случаи.",
        "Окрашенные бордюры тоже относятся к специальной разметке: оранжевый - места для ciclorodados и motovehículos; желтый - запрет стоянки 24 часа."
      ]
    },
    {
    ...
    },
    {
      ...
      itemsRu: [
        "Полиция, пожарные, Defensa Civil и скорая помощь имеют приоритет, когда выполняют свои функции с включенными световыми и/или звуковыми сигналами.",
        "Остальные водители должны освободить предпочтительную полосу для экстренных служб и при необходимости остановиться.",
        "Если включены только balizas, транспорт находится в службе, но не обязательно в экстренном режиме. Однако при некоторых медицинских перевозках сирена может включаться кратко; когда свет включен и звуковой сигнал подается в момент необходимости, путь нужно уступить.",
        ...
        "В крайней необходимости обычный автомобиль может сообщать о подобном срочном случае balizas, прерывистой bocina и размахиванием платком. Приоритета проезда это дает, но правила дорожного движения для такого автомобиля не приостанавливаются."
      ]
    }
  ]
};
