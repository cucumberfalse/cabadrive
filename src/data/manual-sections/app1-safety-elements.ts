  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Если ребенок превышает возраст, рост или вес, он может занимать любое место с трехточечным ремнем; поясной двухточечный ремень источник прямо запрещает для такого случая.",
