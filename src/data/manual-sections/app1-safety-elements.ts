  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Нужно читать руководство автомобиля и проверять, используется ли ремень, Isofix (система крепления детского кресла) или Latch (система крепления детского кресла).",
