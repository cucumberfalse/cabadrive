  ...
  blocks: [
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Опасность потери сцепления на воде (aquaplaning) возникает, когда слой воды отделяет шину от покрытия; в такой ситуации нельзя резко тормозить или дергать рулем.",
