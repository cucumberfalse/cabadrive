...
export const frontPresentationSection: ManualGuideSectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      textRu:
        "Повышение дорожной безопасности - совместная работа всего общества: безопасное поведение продвигает государство, но соблюдать его должны все, кто передвигается по городу."
    },
    {
      ...
      itemsRu: [
        ...
        "Общественная дорога - пространство совместной жизни; поэтому водитель должен думать не только о своем маневре, но и о безопасности окружающих."
      ]
    }
  ]
};
