  ...
  blocks: [
    {
      ...
      textRu:
        "Предупредительное и эффективное вождение - два сквозных понятия хорошей водительской практики."
    },
    {
      ...
      itemsRu: [
        ...
        "Ключевая формула темы: «предвидеть все, ожидать все, предполагать все»."
      ]
    },
    {
    ...
    },
    {
      ...
      textRu:
        "Кондиционер: до 80 km/h лучше охлаждать салон, опуская окна. На более высокой скорости рациональнее использовать кондиционер и держать температуру между 19 и 24 ºC."
    },
    {
    ...
    },
    {
      ...
      itemsRu: [
        ...
        "Если автомобиль будет стоять более 3 минут, двигатель рекомендуется выключить."
      ]
    },
    {
