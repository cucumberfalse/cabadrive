...
- PR #70 landing recovery worktree/branch: `/Users/chap/devel/cabadrive-015-study-guide-language-review-intake` on `codex/015-study-guide-language-review-intake`.
- Recovery decision: fetched/pruned `origin`, fast-forwarded the local PR #70 branch to `origin/codex/015-study-guide-language-review-intake`, merged current `origin/main` into the branch, restored only `content/guide/topic-study-guide.ru.json` and `specs/015-study-guide-language-review/` from `origin/codex/015-study-guide-language-review-final`, and preserved `origin/main` for all unrelated paths.
- Landing cleanup decision: the final rendered-field scan found one remaining learner-facing English fragment in the restored final guide, `because creates risk`, in `pedestrian-crossings-and-priority` ticket `b-fallback-308-a2`. Replaced only that phrase with Russian wording, preserved IDs/placement/answer verdict/source metadata, and refreshed only that topic's `difficultyMeta.sourceFingerprint` from `85b57ed59dd3265cf3af8eea9f3694c3a302582300d6efd4c3242a67ed8a4c7d` to `5f8647c87004ca68a1dd0ec376fe0babd1238f1db94963537515f19199cdf299`.
- Landing recovery validation evidence:
  - JSON parse and structural count guard: pass; totals are 38 topics, 460 unique question IDs, 639 ticket placements, 1,831 answer explanations, 225 trap notes, 4 source-conflict notes, 170 claims, 170 claims with `sourceTraceId`, 0 missing answer tuples, and 0 missing claim traces.
