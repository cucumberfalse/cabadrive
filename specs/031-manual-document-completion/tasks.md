...
| Appendix II content | pages `123-151` | branch `codex/031-appendix-ii`; PR pending until opened | `38ab6bac15a6f90ee7a9520c59cf932c38f5597f` | pending until pushed | implementation complete locally; Appendix II passenger-transport runtime content, source-fidelity registry/evidence, x5 crops, screenshots, tests, preflight, and Docker smoke passed for pages `123-151`; no Appendix III/IV/front-matter or unrelated content bundled; ready for push/PR | yes |
...
| Appendix II | `123-151` | One chapter-equivalent PR covering `app2-social-responsibility`, `app2-safety-elements`, `app2-driving-factors`, `app2-safe-driving`, and `app2-highways-hospitals`; page `123` divider skipped; no new shared page ownership needed | implemented locally in branch `codex/031-appendix-ii`; PR pending until opened after final local verification |
