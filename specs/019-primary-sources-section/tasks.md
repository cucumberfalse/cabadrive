...
- PR #106 Article 44 traffic-light crossing review follow-up on 2026-05-11:
  ...
  - Existing Article 44 `simpleRu` already states that even on green the driver must not enter if there is no space beyond the intersection, so it was left unchanged.
