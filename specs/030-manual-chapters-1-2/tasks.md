...
- Rendered screenshot evidence for `ch1-sustainable-mobility`: regenerated `content/validation/manual-guide/ch1-sustainable-mobility/ch1-sustainable-mobility-mobile.png` at `390x1200` viewport from route `/#manual-section-ch1-sustainable-mobility`; screenshot dimensions `370x1897`; screenshot SHA-256 `5459ee210ec57c760728abfeee6b5eb14711ea216d1c0f5f99cbeec8c5220a94`; visual inspection confirmed the top comparison labels remain readable and the vulnerability labels, including `2-е ВЕЛОСИПЕДИСТЫ`, fit without splitting words.
