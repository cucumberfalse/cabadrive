...
- Rendered screenshot evidence for `ch1-sustainable-mobility`: generated `content/validation/manual-guide/ch1-sustainable-mobility/ch1-sustainable-mobility-mobile.png` at `390x1200` viewport from route `/#manual-section-ch1-sustainable-mobility`; screenshot SHA-256 `567e426046917588520031235fbe7d8f23101fe933b4187d15c3f36a1c26ff27`.
