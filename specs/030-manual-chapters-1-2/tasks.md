...
- [x] Generated runtime non-text source pictogram crops at `content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/sections/ch1-sustainable-mobility/space-comparison-icons-source.jpg` and `vulnerability-icons-source.jpg`; both crops exclude Spanish labels.
...
- Runtime pictogram crop evidence for `ch1-sustainable-mobility`: generated `content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/sections/ch1-sustainable-mobility/space-comparison-icons-source.jpg`; dimensions `585x78`; SHA-256 `1dd898dc1d066c4fe64ae9a7c1e21c82eec9b2c32a5fe340e5e68a0a28816bda`.
...
- Rendered screenshot evidence for `ch1-sustainable-mobility`: generated `content/validation/manual-guide/ch1-sustainable-mobility/ch1-sustainable-mobility-desktop.png` at `1280x1400` viewport from route `/#manual-section-ch1-sustainable-mobility`; screenshot SHA-256 `b3fc9d1dc793e497a49bdcfd0d7a8465480cd0225ff3e448d605fea20bbbd9c5`.
- Rendered screenshot evidence for `ch1-sustainable-mobility`: regenerated `content/validation/manual-guide/ch1-sustainable-mobility/ch1-sustainable-mobility-mobile.png` at `390x1200` viewport from route `/#manual-section-ch1-sustainable-mobility`; screenshot dimensions `370x1993`; screenshot SHA-256 `cb47a3632e22c68fc3b0352cd42391d133d1a9089edf506e5afcad1b96bc0e70`; visual inspection confirmed the top comparison labels remain readable and the vulnerability labels, including `2-е ВЕЛОСИПЕДИСТЫ`, fit without splitting words while every mobile label is paired directly with its corresponding source-derived pictogram.
...
- PR #178 P2 label/pictogram mapping verification for `ch1-sustainable-mobility`: regenerated mobile screenshot `content/validation/manual-guide/ch1-sustainable-mobility/ch1-sustainable-mobility-mobile.png` at `370x1993` with SHA-256 `cb47a3632e22c68fc3b0352cd42391d133d1a9089edf506e5afcad1b96bc0e70`; visual inspection confirmed the 50-person comparison labels and vulnerability ranking labels are paired directly with their source-derived pictograms on mobile, without clipping, horizontal scrolling, or letter-level word splitting.
