...
- 2026-05-10: Rechecked ANSV `Boleta de Pago CENAT` at `https://cnatboleta.com/`. Result: official ANSV page available; confirmed center-of-issuance, personal data, confirmation/payment flow, and volatile displayed amount. Exact amount omitted from evergreen guide prose.
