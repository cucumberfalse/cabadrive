...
- The terminal output-publication response closes R051-063 (`r4105570337`) and
  R051-064 (`r4105697213`): final publication atomically creates a no-replace
  output symlink to the complete, verified journal transaction directory. This
  retains exact crash recovery and complete-tree visibility while an independent
