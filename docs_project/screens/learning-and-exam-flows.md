...
4. Read the exact full Russian translation as ordered layout blocks inside the page composition while local visual material, diagrams, signs, tables, and page hierarchy remain visible.
