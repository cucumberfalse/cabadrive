...
- FR-XXX: `If final validation targets an effective content head, require matching role-owned markers: Effective content head: <40-hex-sha>, Architect validated effective content head: <40-hex-sha>, and Analyst validated effective content head: <40-hex-sha>.`
