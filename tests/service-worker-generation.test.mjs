...
function withTempDist(callback) {
  ...
  try {
    ...
    writeFileSync(join(dist, "content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/cover.jpg"), "cover");
    writeFileSync(join(dist, "content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-001.jpg"), "jpeg");
    writeFileSync(join(dist, "content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-200.jpg"), "jpeg");
    writeFileSync(join(dist, "content/assets/manuals/other-local-guide/pages/page-001.jpg"), "other jpeg");
...
test("service worker install precache excludes deferred manual assets only", () => {
  withTempDist((dist) => {
    ...
    assert.equal(isManualPageImageAsset("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-001.jpg"), true);
    assert.equal(isManualPageImageAsset("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-200.jpg"), true);
    assert.equal(isManualPageImageAsset("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/cover.jpg"), false);
    assert.equal(isManualPageImageAsset("/content/assets/manuals/other-local-guide/pages/page-001.jpg"), false);
    ...
    assert.equal(shouldInstallPrecacheAsset("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-001.jpg"), false);
    assert.equal(shouldInstallPrecacheAsset("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-200.jpg"), false);
    assert.equal(shouldInstallPrecacheAsset("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/cover.jpg"), true);
    assert.equal(shouldInstallPrecacheAsset("/content/assets/manuals/other-local-guide/pages/page-001.jpg"), true);
...
test("generated service worker keeps runtime GET caching for the manual chunk", () => {
  withTempDist((dist) => {
    ...
    assert.equal(assets.includes("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-001.jpg"), false);
    assert.equal(assets.includes("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/pages/page-200.jpg"), false);
    assert.equal(assets.includes("/content/assets/manuals/gcba-manual-vehiculo-4-ruedas-2023/cover.jpg"), true);
    ...
    assert.doesNotMatch(generated, /\/content\/assets\/manuals\/gcba-manual-vehiculo-4-ruedas-2023\/pages\/page-001\.jpg/);
    assert.doesNotMatch(generated, /\/content\/assets\/manuals\/gcba-manual-vehiculo-4-ruedas-2023\/pages\/page-200\.jpg/);
  });
});
