...
test("Chapter 3 sections retain priority, speed, adverse-condition, and parking details", () => {
  ...
  assert.match(ch3SpeedModuleSource, /Camiones, transporte de sustancias peligrosas[\s\S]*80 км\/ч/u);
  assert.match(ch3SpeedModuleSource, /Camionetas, casas rodantes motorizadas, motocicletas[\s\S]*90 км\/ч/u);
  assert.match(ch3SpeedModuleSource, /Motocicletas y automoviles[\s\S]*130 км\/ч/u);
