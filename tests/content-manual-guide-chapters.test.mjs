...
test("Chapter 3 sections retain priority, speed, adverse-condition, and parking details", () => {
  ...
  assert.match(ch3SpeedModuleSource, /40 км\/ч/u);
  assert.match(ch3SpeedModuleSource, /60 км\/ч/u);
  assert.match(ch3SpeedModuleSource, /100 км\/ч/u);
  ...
  assert.match(ch3HighwaysModuleSource, /полосу разгона/u);
  assert.match(ch3HighwaysModuleSource, /полосу замедления/u);
